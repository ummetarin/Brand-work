...
const Contruct = () => {
    return (
     ...
     <div className='w-[1100px] h-[400px]'>
            ...
            <h1 className='font-extrabold text-center lg:text-5xl md:text-4xl text-2xl pt-16 pb-12'>Contruct With Us</h1>
          <form>         
         ...
         <div className='flex lg:flex-row md:flex-row flex-col justify-center gap-14 '>
             ...
             <div className="form-control">
              ...
              <label className="input-group">
             <span className='w-24'>Catagory</span>
              <input type="text"  placeholder="" className="input input-bordered  lg:w-[300px] md:w-[300px] w-[200px]" />
            </label>
             </div>
         </div>
          ...
          <div className='mt-24 lg:ml-96' >
            <button className='text-3xl bg-red-800 w-96 h-16 rounded-md text-white  rounded-lg '>Contruct</button>
          </div>
          </form>
        </div>
        </div>
